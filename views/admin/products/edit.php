...
<form method="POST" action="<?php echo BASE_URL; ?>/cms/products/<?php echo $product['id']; ?>/update" enctype="multipart/form-data">
    <div class="row">
        <div class="col-lg-8">
            <!-- Basic Info -->
            <div class="card mb-3">
            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    <?php if (!empty($product['image'])): ?>
                        <div class="mb-3">
                            <img src="<?php echo BASE_URL . '/' . $product['image']; ?>" alt="" class="img-fluid rounded" style="max-height: 200px;">
                        </div>
                    <?php endif; ?>
                    <div class="mb-3">
                        <label class="form-label">Thay đổi ảnh</label>
                        <input type="file" class="form-control" name="image" accept="image/*">
                        <small class="form-hint">JPG, PNG hoặc GIF. Tối đa 5MB. Để trống nếu không muốn thay đổi.</small>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-body">
                    <button type="submit" class="btn btn-primary w-100 mb-2">
                        <i class="ti ti-check"></i> Cập nhật sản phẩm
                    </button>
                    <form method="POST" action="<?php echo BASE_URL; ?>/cms/products/<?php echo $product['id']; ?>/delete" style="display: inline; width: 100%;">
                        <button type="submit" class="btn btn-danger w-100 delete-confirm">
                            <i class="ti ti-trash"></i> Xóa sản phẩm
                        </button>
                    </form>
                </div>
            </div>
